...
namespace BlueWave.Interop.Asio.Test
{
	...
	public class GuitarEffects
	{
        ...
        private static float[,] _delayRBbuffer;
		...
		[STAThread] public static void Main(string[] args)
		{
            ...
            _delayRBbuffer = new float[driver.BufferSizex.PreferredSize, MaxBuffers];
        ...
        public static void delayEffect(Channel input, Channel outputL, Channel outputR)
        {
            ...
            for (int index = 0; index < outputL.BufferSize; index++)
			{
                ...
                if ((_counter - _FBDelay) >=0 )
                    delayOut = (float)0.3*_delayFBbuffer[index, (_counter - _FBDelay)] + input[index] + (float)0.7*_delayBuffer[index, (_counter - _FBDelay)];
                else
                    delayOut = (float)0.3*_delayFBbuffer[index, (_counter - _FBDelay + MaxBuffers)] + input[index] + (float)0.7*_delayBuffer[index, (_counter - _FBDelay + MaxBuffers)];
